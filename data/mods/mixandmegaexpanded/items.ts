export const Items: import('../../../sim/dex-items').ModdedItemDataTable = {
	...
	meteoritenormal: {
		name: "Meteorite [Normal]",
		onTakeItem: false,
		forcedForme: "Deoxys-Attack",
		itemUser: "Deoxys",
		num: -1,
		gen: 9,
		shortDesc: "Held by Deoxys-Normal to change into Deoxys-Attack",
	},
	meteoriteattack: {
		name: "Meteorite [Attack]",
		onTakeItem: false,
		forcedForme: "Deoxys-Defense",
		itemUser: "Deoxys-Attack",
		num: -2,
		gen: 9,
		shortDesc: "Held by Deoxys-Attack to change into Deoxys-Defense",
	},
	meteoritedefense: {
		name: "Meteorite [Defense]",
		onTakeItem: false,
		forcedForme: "Deoxys-Speed",
		itemUser: "Deoxys-Defense",
		num: -3,
		gen: 9,
		shortDesc: "Held by Deoxys-Defense to change into Deoxys-Speed",
	},
	meteoritespeed: {
		name: "Meteorite [Speed]",
		onTakeItem: false,
		forcedForme: "Deoxys",
		itemUser: "Deoxys-Speed",
		num: -4,
		gen: 9,
		shortDesc: "Held by Deoxys-Speed to change into Deoxys-Normal",
	},
};
